...
namespace BKOXUnitTest
{
    public class BridgeManagerTest
    {
        ...
        public void SitPlayersSucessTest()
        {
            ...
            var auctionMock = new Mock<IAuctionManager>();
            var manager = new BridgeManager(shufflerMock.Object, auctionMock.Object);
        ...
        public void CreateHands()
        {
            ...
            var BridgeManager = new BridgeManager(shufflerMock.Object, auctionMock.Object);
            ...
            var handsCreated = BridgeManager.CreateHands();
        ...
        private static List<Card> PrepareDeck(out List<Card> clubs, out List<Card> diamonds, out List<Card> hearts,
            out List<Card> spades)
        {
            clubs = new List<Card>
            {
